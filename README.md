...
Twenty-eight road assignment models (two, `implicit-ue-nn` and `het-gnn`, require the optional torch extra), a transit optimal-strategy model (Spiess & Florian 1989), and seven OD-estimation baselines ship today, spanning white-box
