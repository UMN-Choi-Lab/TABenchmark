...
Eighteen assignment models and five OD-estimation baselines ship today, spanning white-box
solvers, a stochastic track, elastic and combined-distribution demand, a day-to-day dynamical
system, a boundedly-rational equilibrium, a capacity-constrained equilibrium, and the first learned model — every one certified
