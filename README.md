...
require the optional extra: `pip install tabench[torch]`. On Linux that pulls the
...
Twenty-seven road assignment models (one, `implicit-ue-nn`, requires the optional torch extra), a transit optimal-strategy model (Spiess & Florian 1989), and seven OD-estimation baselines ship today, spanning white-box
